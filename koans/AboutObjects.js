describe("About Objects", function () {
  ...
  it("should confirm that when a function is attached to an object, 'this' refers to the object", function () {
    ...
    expect(currentYear).toBe(currentDate.getFullYear()); // Right now, 2014; Future proof'd
    expect(meglomaniac.calculateAge()).toBe(currentYear - meglomaniac.birthYear); // 44 as of 2014
  });
